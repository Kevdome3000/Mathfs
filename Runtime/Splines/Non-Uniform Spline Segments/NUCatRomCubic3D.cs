...
namespace Freya
{
    ...
    public struct NUCatRomCubic3D : IParamSplineSegment<Polynomial3D, Vector3Matrix4x1>
    {
        ...
        // serialized data
        [SerializeField]
        private Vector3Matrix4x1 pointMatrix;
        ...
        [SerializeField]
        private KnotCalcMode knotCalcMode; // knot recalculation mode

        [SerializeField]
        private float alpha; // alpha parameterization

        private Polynomial3D curve;
        ...
        {
            var a = Mathfs.InverseLerp(K0, K1, u);
            var b = Mathfs.InverseLerp(K1, K2, u);
            var c = Mathfs.InverseLerp(K2, K3, u);
            var d = Mathfs.InverseLerp(K0, K2, u);
            var g = Mathfs.InverseLerp(K1, K3, u);

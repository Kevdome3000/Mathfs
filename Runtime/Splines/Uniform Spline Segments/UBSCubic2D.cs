...
namespace Freya
{
    ...
    [Serializable]
    public struct UBSCubic2D : IParamSplineSegment<Polynomial2D, Vector2Matrix4x1>
    {
        ...
        public static explicit operator UBSCubic3D(UBSCubic2D curve2D) => new(curve2D.P0, curve2D.P1, curve2D.P2, curve2D.P3);

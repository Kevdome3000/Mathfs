...
namespace Freya
{
    ...
    [Serializable]
    public struct UBSCubic3D : IParamSplineSegment<Polynomial3D, Vector3Matrix4x1>
    {
        ...
        public static explicit operator UBSCubic2D(UBSCubic3D curve3D) => new(curve3D.P0, curve3D.P1, curve3D.P2, curve3D.P3);

...
namespace Freya
{
    ...
    [Serializable]
    public struct CatRomCubic2D : IParamSplineSegment<Polynomial2D, Vector2Matrix4x1>
    {
        ...
        public static explicit operator CatRomCubic3D(CatRomCubic2D curve2D) => new(curve2D.P0, curve2D.P1, curve2D.P2, curve2D.P3);

...
namespace Freya
{
    ...
    [Serializable]
    public struct HermiteCubic3D : IParamSplineSegment<Polynomial3D, Vector3Matrix4x1>
    {
        ...
        public static explicit operator HermiteCubic2D(HermiteCubic3D curve3D) => new(curve3D.P0, curve3D.V0, curve3D.P1, curve3D.V1);

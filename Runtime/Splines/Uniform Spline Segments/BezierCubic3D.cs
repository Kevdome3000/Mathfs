...
namespace Freya
{
    ...
    [Serializable]
    public struct BezierCubic3D : IParamSplineSegment<Polynomial3D, Vector3Matrix4x1>
    {
        ...
        public static explicit operator BezierCubic2D(BezierCubic3D curve3D) => new(curve3D.P0, curve3D.P1, curve3D.P2, curve3D.P3);
        ...
        {
            var P0 = Vector3.LerpUnclamped(a.P0, b.P0, t);
            var P3 = Vector3.LerpUnclamped(a.P3, b.P3, t);

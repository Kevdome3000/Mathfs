...
namespace Freya
{
    ...
    [Serializable]
    public struct BezierCubic2D : IParamSplineSegment<Polynomial2D, Vector2Matrix4x1>
    {
        ...
        public static explicit operator BezierCubic3D(BezierCubic2D curve2D) => new(curve2D.P0, curve2D.P1, curve2D.P2, curve2D.P3);
        ...
        {
            var P0 = Vector2.LerpUnclamped(a.P0, b.P0, t);
            var P3 = Vector2.LerpUnclamped(a.P3, b.P3, t);

...
namespace Freya
{
    ...
    public struct Polynomial3D : IParamCurve3Diff<Vector3>
    {
        ...
        public Polynomial3D(Vector3 c0, Vector3 c1, Vector3 c2, Vector3 c3)
        {
            ...
            z = new Polynomial(c0.z, c1.z, c2.z, c3.z);
        }

        /// <inheritdoc cref="Polynomial(float,float,float)"/>
        public Polynomial3D(Vector3 c0, Vector3 c1, Vector3 c2)
        {
            x = new Polynomial(c0.x, c1.x, c2.x, 0);
            y = new Polynomial(c0.y, c1.y, c2.y, 0);
            z = new Polynomial(c0.z, c1.z, c2.z, 0);
        }

        /// <inheritdoc cref="Polynomial(float,float)"/>
        public Polynomial3D(Vector3 c0, Vector3 c1)
        {
            x = new Polynomial(c0.x, c1.x, 0, 0);
            y = new Polynomial(c0.y, c1.y, 0, 0);
            z = new Polynomial(c0.z, c1.z, 0, 0);
        }

...
namespace Freya
{
    ...
    public static class IParamCurveExt2D
    {
        ...
        public static float GetArcLength<T>(this T curve, FloatRange interval, int accuracy = 8) where T : IParamCurve<Vector2>
        {
            ...
            float totalDist = 0;
            var prev = curve.Eval(interval.a);
    ...
    public static class IParamCurve1DiffExt3D
    {
        ...
        [MethodImpl(INLINE)]
        public static Vector3 EvalNormal<T>(this T curve, float t, Vector3 up) where T : IParamCurve1Diff<Vector3> => GetNormalFromLookTangent(curve.EvalDerivative(t), up);
        ...
        [MethodImpl(INLINE)]
        public static Vector3 EvalBinormal<T>(this T curve, float t, Vector3 up) where T : IParamCurve1Diff<Vector3> => GetBinormalFromLookTangent(curve.EvalDerivative(t), up);
        ...
        [MethodImpl(INLINE)]
        public static Quaternion EvalOrientation<T>(this T curve, float t, Vector3 up) where T : IParamCurve1Diff<Vector3> => Quaternion.LookRotation(curve.EvalDerivative(t), up);
        ...
        /// <param name="up">The reference up vector. The Y axis will attempt to be as aligned with this vector as much as possible</param>
        [MethodImpl(INLINE)]
        public static Pose EvalPose<T>(this T curve, float t, Vector3 up) where T : IParamCurve1Diff<Vector3> => new(curve.Eval(t), Quaternion.LookRotation(curve.EvalDerivative(t), up));
        ...
        {
            var (Pt, Tn) = (curve.Eval(t), curve.EvalTangent(t));
    ...
    public static class IParamCurve2DiffExt2D
    {
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static float EvalCurvature<T>(this T curve, float t) where T : IParamCurve2Diff<Vector2> => GetCurvature(curve.EvalDerivative(t), curve.EvalSecondDerivative(t));
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Circle2D EvalOsculatingCircle<T>(this T curve, float t) where T : IParamCurve2Diff<Vector2> => Circle2D.GetOsculatingCircle(curve.Eval(t), curve.EvalDerivative(t), curve.EvalSecondDerivative(t));
    ...
    public static class IParamCurve2DiffExt3D
    {
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Vector3 EvalCurvature<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3> => GetCurvature(curve.EvalDerivative(t), curve.EvalSecondDerivative(t));
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Vector3 EvalArcNormal<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3> => GetArcNormal(curve.EvalDerivative(t), curve.EvalSecondDerivative(t));

        /// <summary>Returns the frenet-serret (curvature-based) binormal direction at the given t-value on the curve</summary>
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Vector3 EvalArcBinormal<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3> => GetArcBinormal(curve.EvalDerivative(t), curve.EvalSecondDerivative(t));
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Quaternion EvalArcOrientation<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3> => GetArcOrientation(curve.EvalDerivative(t), curve.EvalSecondDerivative(t));
    ...
    public static class IParamCurve3DiffExt3D
    {
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static float EvalTorsion<T>(this T curve, float t) where T : IParamCurve3Diff<Vector3> => GetTorsion(curve.EvalDerivative(t), curve.EvalSecondDerivative(t), curve.EvalThirdDerivative(t));
    }

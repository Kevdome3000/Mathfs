...
namespace Freya
{
    ...
    public readonly struct FloatRange
    {
        ...
        {
            var separation = Mathfs.Abs(other.Center - Center);
        ...
        public FloatRange ScaleFromStart(float scale) => new(a, a + scale * (b - a));

        /// <summary>Returns this range mirrored around a given value</summary>
        /// <param name="pivot">The value to mirror around</param>
        public FloatRange MirrorAround(float pivot) => new(2 * pivot - a, 2 * pivot - b);

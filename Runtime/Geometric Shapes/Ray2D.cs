...
namespace Freya
{
    ...
    public struct Ray2D : ILinear2D
    {
        ...
        public static implicit operator Ray2D(Ray ray) => new(ray.origin, ray.direction);

        /// <summary>Implicitly casts a Mathfs ray to a Unity ray</summary>
        /// <param name="ray">The ray to cast to a Mathfs ray</param>
        public static implicit operator UnityEngine.Ray2D(Ray2D ray) => new(ray.origin, ray.dir);

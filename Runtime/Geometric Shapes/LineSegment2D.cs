...
namespace Freya
{
    ...
    public struct LineSegment2D : ILinear2D
    {
        ...
        [MethodImpl(INLINE)]
        public static Line2D GetBisector(Vector2 startPoint, Vector2 endPoint) => new((startPoint + endPoint) * 0.5f, (startPoint - endPoint).Rotate90CCW());
        ...
        [MethodImpl(INLINE)]
        float ILinear2D.ClampTValue(float t) => t < 0 ? 0 :
            t > 1 ? 1 : t;

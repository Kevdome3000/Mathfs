...
namespace Freya
{
    ...
    public struct Line2D : ILinear2D
    {
        ...
        public Line2D Normalized => new(origin, dir);
        ...
        [MethodImpl(INLINE)]
        public float SignedDistance(Vector2 point) => Determinant(dir.normalized, point - origin);
        ...
        [MethodImpl(INLINE)]
        public static float ProjectPointToLineTValue(Vector2 lineOrigin, Vector2 lineDir, Vector2 point) => Vector2.Dot(lineDir, point - lineOrigin) / Vector2.Dot(lineDir, lineDir);
        ...
        /// <param name="point">The point to project onto the line</param>
        [MethodImpl(INLINE)]
        public static Vector2 ProjectPointToLine(Vector2 lineOrigin, Vector2 lineDir, Vector2 point) => lineOrigin + lineDir * ProjectPointToLineTValue(lineOrigin, lineDir, point);
        ...
        [MethodImpl(INLINE)]
        public static float PointToPlaneSignedDistance(Vector2 planeOrigin, Vector2 planeNormal, Vector2 point) => Vector2.Dot(point - planeOrigin, planeNormal);
        ...
        /// <param name="point">The point to use when checking distance to the plane</param>
        [MethodImpl(INLINE)]
        public static float PointToPlaneDistance(Vector2 planeOrigin, Vector2 planeNormal, Vector2 point) => Abs(PointToPlaneSignedDistance(planeOrigin, planeNormal, point));

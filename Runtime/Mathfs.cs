...
namespace Freya
{
    ...
    public static class Mathfs
    {
        ...
        [MethodImpl(INLINE)]
        public static Vector2 Sqrt(Vector2 v) => new(Sqrt(v.x), Sqrt(v.y));

        /// <inheritdoc cref="Mathfs.Sqrt(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector3 Sqrt(Vector3 v) => new(Sqrt(v.x), Sqrt(v.y), Sqrt(v.z));

        /// <inheritdoc cref="Mathfs.Sqrt(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector4 Sqrt(Vector4 v) => new(Sqrt(v.x), Sqrt(v.y), Sqrt(v.z), Sqrt(v.w));
        ...
        private static readonly long[] factorialLong =
        {
            /*0*/ 1,
            /*1*/ 1,
            /*2*/ 2,
        ...
        private static readonly int[] factorialInt =
        {
            /*0*/ 1,
            /*1*/ 1,
            /*2*/ 2,
        ...
        private const double SINC_P_C2 = -1 / 6.0;
        private const double SINC_P_C4 = 1 / 120.0;
        private const double SINCRCP_P_C2 = 1 / 6.0;
        private const double SINCRCP_P_C4 = 7 / 360.0;
        ...
        [MethodImpl(INLINE)]
        public static Vector3 Abs(Vector3 v) => new(Abs(v.x), Abs(v.y), Abs(v.z));

        /// <inheritdoc cref="Mathfs.Abs(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector4 Abs(Vector4 v) => new(Abs(v.x), Abs(v.y), Abs(v.z), Abs(v.w));
        ...
        public static float Clamp(float value, float min, float max) => value < min ? min :
            value > max ? max : value;
        ...
        public static int Clamp(int value, int min, int max) => value < min ? min :
            value > max ? max : value;

        /// <summary>Returns the value clamped between 0 and 1</summary>
        public static float Clamp01(float value) => value < 0f ? 0f :
            value > 1f ? 1f : value;
        ...
        public static float ClampNeg1to1(float value) => value < -1f ? -1f :
            value > 1f ? 1f : value;
        ...
        [MethodImpl(INLINE)]
        public static Vector2 Sign(Vector2 value) => new(value.x >= 0f ? 1 : -1, value.y >= 0f ? 1 : -1);

        /// <inheritdoc cref="Mathfs.Sign(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector3 Sign(Vector3 value) => new(value.x >= 0f ? 1 : -1, value.y >= 0f ? 1 : -1, value.z >= 0f ? 1 : -1);

        /// <inheritdoc cref="Mathfs.Sign(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector4 Sign(Vector4 value) => new(value.x >= 0f ? 1 : -1, value.y >= 0f ? 1 : -1, value.z >= 0f ? 1 : -1, value.w >= 0f ? 1 : -1);
        ...
        [MethodImpl(INLINE)]
        public static Vector2 Floor(Vector2 value) => new((float)Math.Floor(value.x), (float)Math.Floor(value.y));

        /// <inheritdoc cref="Mathfs.Floor(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector3 Floor(Vector3 value) => new((float)Math.Floor(value.x), (float)Math.Floor(value.y), (float)Math.Floor(value.z));

        /// <inheritdoc cref="Mathfs.Floor(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector4 Floor(Vector4 value) => new((float)Math.Floor(value.x), (float)Math.Floor(value.y), (float)Math.Floor(value.z), (float)Math.Floor(value.w));
        ...
        [MethodImpl(INLINE)]
        public static Vector2Int FloorToInt(Vector2 value) => new((int)Math.Floor(value.x), (int)Math.Floor(value.y));

        /// <inheritdoc cref="Mathfs.FloorToInt(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector3Int FloorToInt(Vector3 value) => new((int)Math.Floor(value.x), (int)Math.Floor(value.y), (int)Math.Floor(value.z));
        ...
        [MethodImpl(INLINE)]
        public static Vector2 Ceil(Vector2 value) => new((float)Math.Ceiling(value.x), (float)Math.Ceiling(value.y));

        /// <inheritdoc cref="Mathfs.Ceil(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector3 Ceil(Vector3 value) => new((float)Math.Ceiling(value.x), (float)Math.Ceiling(value.y), (float)Math.Ceiling(value.z));

        /// <inheritdoc cref="Mathfs.Ceil(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector4 Ceil(Vector4 value) => new((float)Math.Ceiling(value.x), (float)Math.Ceiling(value.y), (float)Math.Ceiling(value.z), (float)Math.Ceiling(value.w));
        ...
        [MethodImpl(INLINE)]
        public static Vector2Int CeilToInt(Vector2 value) => new((int)Math.Ceiling(value.x), (int)Math.Ceiling(value.y));

        /// <inheritdoc cref="Mathfs.CeilToInt(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector3Int CeilToInt(Vector3 value) => new((int)Math.Ceiling(value.x), (int)Math.Ceiling(value.y), (int)Math.Ceiling(value.z));

        /// <summary>Rounds the value to the nearest integer</summary>
        [MethodImpl(INLINE)]
        public static float Round(float value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => (float)MathF.Round(value, midpointRounding);

        /// <summary>Rounds the vector components to the nearest integer</summary>
        [MethodImpl(INLINE)]
        public static Vector2 Round(Vector2 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new((float)Math.Round(value.x, midpointRounding), (float)Math.Round(value.y, midpointRounding));

        /// <inheritdoc cref="Mathfs.Round(Vector2,MidpointRounding)"/>
        [MethodImpl(INLINE)]
        public static Vector3 Round(Vector3 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new((float)Math.Round(value.x, midpointRounding), (float)Math.Round(value.y, midpointRounding), (float)Math.Round(value.z, midpointRounding));

        /// <inheritdoc cref="Mathfs.Round(Vector2,MidpointRounding)"/>
        [MethodImpl(INLINE)]
        public static Vector4 Round(Vector4 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new((float)Math.Round(value.x, midpointRounding), (float)Math.Round(value.y, midpointRounding), (float)Math.Round(value.z, midpointRounding), (float)Math.Round(value.w, midpointRounding));

        /// <summary>Rounds the value to the nearest value, snapped to the given interval size</summary>
        [MethodImpl(INLINE)]
        public static float Round(float value, float snapInterval, MidpointRounding midpointRounding = MidpointRounding.ToEven) => (float)Math.Round(value / snapInterval, midpointRounding) * snapInterval;

        /// <summary>Rounds the vector components to the nearest value, snapped to the given interval size</summary>
        [MethodImpl(INLINE)]
        public static Vector2 Round(Vector2 value, float snapInterval, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new(Round(value.x, snapInterval, midpointRounding), Round(value.y, snapInterval, midpointRounding));

        /// <inheritdoc cref="Mathfs.Round(Vector2,float,MidpointRounding)"/>
        [MethodImpl(INLINE)]
        public static Vector3 Round(Vector3 value, float snapInterval, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new(Round(value.x, snapInterval, midpointRounding), Round(value.y, snapInterval, midpointRounding), Round(value.z, snapInterval, midpointRounding));

        /// <inheritdoc cref="Mathfs.Round(Vector2,float,MidpointRounding)"/>
        [MethodImpl(INLINE)]
        public static Vector4 Round(Vector4 value, float snapInterval, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new(Round(value.x, snapInterval, midpointRounding), Round(value.y, snapInterval, midpointRounding), Round(value.z, snapInterval, midpointRounding), Round(value.w, snapInterval, midpointRounding));

        /// <summary>Rounds the value to the nearest integer, returning an int value</summary>
        [MethodImpl(INLINE)]
        public static int RoundToInt(float value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => (int)Math.Round(value, midpointRounding);

        /// <summary>Rounds the vector components to the nearest integer, returning an integer vector</summary>
        [MethodImpl(INLINE)]
        public static Vector2Int RoundToInt(Vector2 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new((int)Math.Round(value.x, midpointRounding), (int)Math.Round(value.y, midpointRounding));

        /// <inheritdoc cref="Mathfs.RoundToInt(Vector2,MidpointRounding)"/>
        [MethodImpl(INLINE)]
        public static Vector3Int RoundToInt(Vector3 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) => new((int)Math.Round(value.x, midpointRounding), (int)Math.Round(value.y, midpointRounding), (int)Math.Round(value.z, midpointRounding));
        ...
        [MethodImpl(INLINE)]
        public static Vector2 Frac(Vector2 v) => new(v.x - Floor(v.x), v.y - Floor(v.y));

        /// <inheritdoc cref="Mathfs.Frac(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector3 Frac(Vector3 v) => new(v.x - Floor(v.x), v.y - Floor(v.y), v.z - Floor(v.z));

        /// <inheritdoc cref="Mathfs.Frac(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector4 Frac(Vector4 v) => new(v.x - Floor(v.x), v.y - Floor(v.y), v.z - Floor(v.z), v.w - Floor(v.w));
        ...
        /// <inheritdoc cref="Mathfs.InverseLerp(Vector2,Vector2,Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector4 InverseLerp(Vector4 a, Vector4 b, Vector4 v) => new((v.x - a.x) / (b.x - a.x), (v.y - a.y) / (b.y - a.y), (v.z - a.z) / (b.z - a.z), (v.w - a.w) / (b.w - a.w));
        ...
        [MethodImpl(INLINE)]
        public static float Remap(FloatRange inRange, FloatRange outRange, float value) => Remap(inRange.a, inRange.b, outRange.a, outRange.b, value);
        ...
        /// <param name="value">The value to remap from the input range</param>
        [MethodImpl(INLINE)]
        public static float RemapClamped(FloatRange inRange, FloatRange outRange, float value) => RemapClamped(inRange.a, inRange.b, outRange.a, outRange.b, value);
        ...
        [MethodImpl(INLINE)]
        public static Vector2 AngToDir(float aRad) => new(Mathf.Cos(aRad), Mathf.Sin(aRad));
        ...
        /// <param name="v">The direction to create a 2D orientation from (does not have to be normalized)</param>
        [MethodImpl(INLINE)]
        public static Pose PointDirToPose(Vector2 pt, Vector2 v) => new(pt, DirToOrientation(v));
        ...
        {
            var cVector = Vector3.Cross(velocity, acceleration);
        ...
        /// <param name="acceleration">The second derivative of the point in the curve</param>
        [MethodImpl(INLINE)]
        public static Vector3 GetArcNormal(Vector3 velocity, Vector3 acceleration) => Vector3.Cross(Vector3.Cross(velocity, acceleration).normalized, velocity.normalized);
        ...
        {
            var binormal = Vector3.Cross(velocity, acceleration);
        ...
        public static Vector2 SquareToDisc(Vector2 c)
        {
            ...
            var u = c.x * Sqrt(1 - c.y * c.y / 2);
            var v = c.y * Sqrt(1 - c.x * c.x / 2);
        ...
        public static Vector2 DiscToSquare(Vector2 c)
        {
            ...
            var p = new Vector2(2, 2) + n * (u2 - v2);
            var q = 2 * SQRT2 * c;
            var smolVec = Vector2.one * 0.0001f;
